...
slug: 1.0/schema/administrative
---
...
These properties concern the ID, creation and version details of the content.

| Property | Lvl 2 | Lvl 3 | Type | Description |
| --- | --- | --- | --- | --- |
| uri |  |  | String | Live event unique identifier |
| id |  |  | String | A user-facing live event ID |
